...
contacts.each_with_index do |(contact_key, contact_value), contact_index|
  contact_fields.each_with_index do |contact_field_name, field_index|
    contacts[contact_key][contact_field_name] = contact_data[contact_index][field_index]
  end
end
